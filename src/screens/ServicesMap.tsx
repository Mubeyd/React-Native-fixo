...
const ServicesMap = () => {
  ...
  let checkIfLocaionIsON =
    currentLocation.latitude === 37.034411
      ? (viewLocation = false)
      : (viewLocation = true)
  ...
  const renderInner = () => (
    <View style={styles.panel}>
      ...
      <Text style={{margin: 6, fontWeight: 'bold'}}>Record a message</Text>
    ...
    <View style={styles.container}>
      ...
      <ReAnimated.View
        ...
        <View style={styles.gpsIcon1}>
          <MaterialIcons onPress={() => pdsFunc()} name="gps-fixed" size={36} />
        </View>
      </ReAnimated.View>
    </View>
  )
